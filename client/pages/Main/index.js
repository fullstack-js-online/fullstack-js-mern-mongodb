...
// components
import Flash from '@client/pages/Main/components/Flash'
import Topbar from '@client/pages/Main/components/Topbar'
import PageLoader from '@components/PageLoader'
import SendEmailConfirm from '@client/pages/Main/components/SendEmailConfirm'
...
export class Main extends Component {
  ...
  resendEmailConfirmation = () => {
    ...
    dispatch(postResendEmailConfirm({ email }))
      ...
      .catch(() => {
        dispatch(
          flashMessage('Error sending password reset link.', { isError: true })
        )
      })
  }
