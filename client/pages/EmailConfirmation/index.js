...
// components
import EmailConfirmationLoader from '@client/pages/EmailConfirmation/components/EmailConfirmationLoader'
  ...
  componentDidMount() {
    ...
    dispatch(postEmailConfirm({ token }))
      ...
      .catch(() => {
        ...
        dispatch(flashMessage('Error confirming email.', { isError: true }))
      })
  }
